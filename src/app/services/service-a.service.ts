...
export class ServiceA {
    ...
    createBaseComponent(viewContainerRef: ViewContainerRef, typeOfSubComponent: any) {
        ...
        // set references in the base component so that the base component knows what type of sub-component to instantiate
